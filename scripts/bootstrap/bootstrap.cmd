@echo off
setlocal
REM bootstrap.cmd - locate Python 3.11 without hitting Windows Store alias (exit 9009)
set "PY_CANDIDATE="
...
:found
if "%PY_CANDIDATE%"=="" (
  echo [bootstrap.cmd] FAIL: Python 3.11 not found
...
echo [bootstrap.cmd] using Python: %PY_CANDIDATE%
...
set "SCRIPT=%~dp0bootstrap_dev_env.py"
%PY_CANDIDATE% "%SCRIPT%" %*
set "CODE=%ERRORLEVEL%"
if "%CODE%"=="9009" echo [bootstrap.cmd] FAIL 9009: Windows Store python alias
exit /b %CODE%

...
func _ready() -> void :
				Genes.connect("gene_edited", Callable(self, "render"))
				GameState.connect("settings_changed", Callable(self, "_on_settings_changed"))
				GameState.connect("changed", Callable(self, "_update_resources"))
...
func _on_Button_pressed() -> void :
				...
				confirm_dialog.connect("confirmed", Callable(self, "_on_delete_gene"))

...
func switch_levels(stage_id, reset = false, zone_level_override = null):
				...
				if destination_scene:
								...
								level = destination_scene.instance()
								...
								level.connect("status_changed", $LoadingScreen, "on_status_change")
								level.connect("map_done", self, "_on_map_loaded")
								level.connect("map_done", $GUI, "_refresh_on_new_map")

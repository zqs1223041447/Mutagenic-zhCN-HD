...
func _ready() -> void :
				...
				$PassiveButton.connect("mouse_entered", $PassiveButton, "grab_focus")
				$PassiveButton.connect("mouse_exited", $PassiveButton, "release_focus")
				$PassiveButton.connect("focus_entered", self, "show_hover")
				$PassiveButton.connect("focus_exited", self, "hide_hover")
				...
				GameState.connect("passives_changed", self, "_resync")
				Globals.connect("search_changed", self, "_on_search_change")

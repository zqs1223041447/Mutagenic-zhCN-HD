...
func initialize():
				Steam.connect("inventory_full_update", self, "handle_inventory_full_update")
				Steam.connect("inventory_request_prices_result", self, "handle_inventory_request_prices_result")
				Steam.connect("inventory_start_purchase_result", self, "handle_inventory_start_purchase_result")
				Steam.connect("inventory_result_ready", self, "handle_inventory_result_ready")
				fetch_items()
				request_prices()
